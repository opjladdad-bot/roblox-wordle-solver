...
local REPO_URL = "https://raw.githubusercontent.com/YOUR_USERNAME/roblox-wordle-solver/main/"
local LIST_URL = REPO_URL .. "WordList.lua"
local SOLVER_URL = REPO_URL .. "WordleSolver.lua"
